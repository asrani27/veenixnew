...
@section('title', $genre->name . ' - veenix')
@section('description', 'Nonton film dan TV series genre ' . $genre->name . ' subtitle Indonesia. Streaming movie & TV
series dengan kualitas HD gratis di veenix.')
@section('keywords', 'nonton film, streaming movie, TV series, genre ' . $genre->name . ', subtitle Indonesia, gratis,
HD')
@section('canonical', url('/genre/' . $genre->slug))
        ...
        <main class="lg:col-span-3">
            ...
            <div class="py-4 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-bold text-white mb-2">Genre: {{ $genre->name }}</h1>
                        <p class="text-gray-400">Temukan film dan TV series genre {{ $genre->name }} terbaru</p>
                    </div>
            ...
            @php
            $allContent = $movies->concat($tvShows)->sortByDesc('views')->take(12);
            @endphp
                    ...
                    <a href="/movie/{{ $item->slug }}" class="group cursor-pointer flex-shrink-0 w-32 sm:w-auto">
                        ...
                        <div class="mt-3 text-center">
                            ...
                            <div class="flex items-center justify-center text-gray-400 text-xs mt-1">
                                <span class="flex items-center"><i class="fas fa-eye mr-1"></i>{{ $item->views ?? 0
                                    }}</span>
                            </div>
                        </div>
                    </a>
            ...
            <div class="text-center py-16">
                ...
                <p class="text-gray-400">No movies or TV series found for genre {{ $genre->name }}</p>
                <a href="/"
