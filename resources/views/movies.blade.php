...
@section('title', 'Movies - veenix')
@section('description', 'Nonton film terbaru subtitle Indonesia. Streaming movie dengan kualitas HD gratis di veenix.')
@section('keywords', 'nonton film, streaming movie, subtitle Indonesia, gratis, HD')
@section('canonical', url('/movies'))
        ...
        <main class="lg:col-span-3">
            ...
            <div class="py-4 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-bold text-white mb-2">Movies</h1>
                        <p class="text-gray-400">Temukan film terbaru dan terpopuler</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="text-right">
                            <p class="text-sm text-gray-400">Total Movies</p>
                            <p class="text-2xl font-bold text-white">{{ $movies->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section class="py-4" aria-labelledby="movies-heading">
                <div class="flex justify-between items-center mb-4">
                    <h2 id="movies-heading" class="text-2xl sm:text-3xl font-bold text-white">Semua Movies</h2>
