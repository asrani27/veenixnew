...
@section('title', 'TV Series - veenix')
@section('description', 'Nonton TV series terbaru subtitle Indonesia. Streaming drama Korea dan TV series dengan kualitas HD gratis di veenix.')
@section('keywords', 'nonton TV series, streaming drama Korea, TV series, subtitle Indonesia, gratis, HD')
@section('canonical', url('/tv'))
        ...
        <main class="lg:col-span-3">
            ...
            <div class="py-4 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-bold text-white mb-2">TV Series</h1>
                        <p class="text-gray-400">Temukan drama Korea dan TV series terbaru</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="text-right">
                            <p class="text-sm text-gray-400">Total TV Series</p>
                            <p class="text-2xl font-bold text-white">{{ $tvShows->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section class="py-4" aria-labelledby="tv-series-heading">
                <div class="flex justify-between items-center mb-4">
                    <h2 id="tv-series-heading" class="text-2xl sm:text-3xl font-bold text-white">Semua TV Series</h2>
                    <div class="flex items-center space-x-2">
                        @if(request()->has('country'))
                            <a href="/tv"
                                class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 border border-transparent text-xs sm:text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200">
                ...
                <div
                    class="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 sm:gap-2 md:gap-3">
                        ...
                        <a href="/tv/{{ $show->slug }}"
                            ...
                            <div class="flex items-center justify-center text-gray-400 text-xs mt-1">
                                <span class="flex items-center"><i class="fas fa-eye mr-1"></i>
                                    {{ $show->seasons->sum(function($season) {
            ...
            <div class="text-center py-16">
                ...
                <h2 class="text-2xl font-bold text-white mb-2">No TV Series Found</h2>
                <p class="text-gray-400">No TV series found</p>
                <a href="/" class="inline-flex items-center px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white font-medium rounded-lg transition-colors mt-4">
                    <i class="fas fa-home mr-2"></i>
                    Back to Home
                </a>
            </div>
